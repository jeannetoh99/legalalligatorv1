        ...
        return (
            <div className="w-full pr-12 mr-12 my-auto">
                <HashLink to='#overview'>
                    <h1 className="lato font-medium text-lg py-3 cursor-pointer border-r-4 border-gray-400 text-gray-600
                    hover:font-semibold hover:border-gray-900 hover:text-gray-900 pr-2">Overview</h1>
                </HashLink>
                {checkpoints.map((data) => {
                    return (
                        <HashLink to={`#${data.id}`}>
                            <h1 className="lato font-medium text-medium py-3 pr-2 cursor-pointer border-r-4 border-gray-400 
            ...
            <div id="overview" className="pt-40">
                ...
                <div className="w-full flex">
                    <div className="w-2/3 pr-10">
                        ...
                        <p className="text-gray-700 la-h4 whitespace-pre-wrap">{actionSummary.details}</p>
                        <div className="w-full my-8 flex">
                            <div className="w-1/2">
                                <h3 className="la-h3 text-gray-800 py-2">Cost Estimate</h3>
                                <h3 className="la-h3 text-gray-500 py-2">{actionSummary.cost_estimate}</h3>
                            </div>
                            <div className="w-1/2">
                                <h3 className="la-h3 text-gray-800 py-2">Duration Estimate</h3>
                                <h3 className="la-h3 text-gray-500 py-2 whitespace-pre-wrap">{actionSummary.duration_estimate}</h3>
                            </div>
                        </div>
                    </div>
                    <div className="w-1/3">
